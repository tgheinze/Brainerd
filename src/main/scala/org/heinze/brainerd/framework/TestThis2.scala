...
object TestThis2 extends App {
  ...
  def tokenize(text: String): Array[com.tr.research.util.tokenizer.Token] = {
  ...
  def getSentences(tokens: List[com.tr.research.util.tokenizer.Token]): List[(Int, Int)] = {
  ...
  def getSentencesLF(tokens: List[com.tr.research.util.tokenizer.Token]): List[(Int, Int)] = {
  ...
  def mergeOp(a: List[(Int, Int)], b: com.tr.research.util.tokenizer.Token): List[(Int, Int)] = {
