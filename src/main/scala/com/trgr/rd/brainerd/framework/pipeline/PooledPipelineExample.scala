package com.trgr.rd.nlp.framework.pipeline

import com.weiglewilczek.slf4s.Logging
import com.trgr.rd.brainerd.framework.artifacts.CAS
import com.trgr.rd.brainerd.framework.util.PooledPipeline
...
object PooledPipelineExample extends App with Logging {
  ...
  import com.trgr.rd.nlp.framework.util.{RNAMongoStorage, ComponentFactoryLoaderPool}
