package com.trgr.rd.brainerd.framework.pipeline

import com.weiglewilczek.slf4s.Logging
import com.trgr.rd.brainerd.framework.artifacts.CAS
import com.trgr.rd.brainerd.framework.util.{ReadFiles, PooledPipeline}
import com.trgr.rd.brainerd.framework.components.{CVSReader, MongoRNALoader}
...
object RNALoaderPipeline extends App with Logging {
  ...
  import com.trgr.rd.nlp.framework.util.RNAMongoStorage
  import com.trgr.rd.nlp.framework.component._
